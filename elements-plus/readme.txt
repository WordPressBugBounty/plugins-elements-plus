...
Check out [the demo](https://www.cssigniter.com/elementor-demos/elements-plus/) now!
...
= 2.16.3 =
* Properly escape links on output. Fixes CVE-2024-2335
* Fixed issues caused by namespace change of the SafeSVG plugin.
* Removed hooks on actions element/before_render and element/after_render that were deprecated before Elementor v2.2
* Fixed issue where Hotspots element would throw a warning when saved without an image assigned.
* Replaced calls to deprecated Elementor\Core\Schemes\Typography and Elementor\Core\Schemes\Color classes.
* Fixed Button element icon.
