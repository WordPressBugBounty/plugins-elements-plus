		...
		protected function render() {
			...
			<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
				...
				<span <?php $this->print_render_attribute_string( 'content-wrapper' ); ?>>
					<span class="elementor-button-text button-plus text-1"><?php $this->print_unescaped_setting( 'text' ); ?></span>
					<span class="elementor-button-text button-plus text-2"><?php $this->print_unescaped_setting( 'text_2' ); ?></span>
				</span>
				</a>
			</div>
			<?php
